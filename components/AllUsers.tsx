      ...
      {showCreateGroup && (
        <div className="fixed  inset-0 bg-black/50 z-60 flex items-center justify-center p-4">
          <div className="bg-gray-900/95 backdrop-blur-sm rounded-xl shadow-xl border border-gray-800/50 w-full max-w-md p-6">
            ...
            >
              <div
                className=" bg-black/50 rounded-full flex items-center justify-center cursor-pointer w-[100px] h-[100px] mx-auto"
              ...
              <div className="space-y-2">
                <label htmlFor="groupName" className="text-sm text-gray-300 font-medium">
                  Group Name
                </label>
                <input
                  id="groupName"
                  ...
                  className="w-full px-4 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500/50 transition-colors"
                  required
                />
              </div>
              ...
              {/* Description Input */}
              <div className="space-y-2">
                <label htmlFor="description" className="text-sm text-gray-300 font-medium">
                  Description
                </label>
                <textarea
                  id="description"
                  ...
                  rows={3}
                  className="w-full px-4 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500/50 transition-colors resize-none"
                />
              </div>
